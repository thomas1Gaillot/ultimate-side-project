                    ...
                    {preIntegres.map(p => {
                        ...
                        return (
                            <TableRow key={p.id}>
                                ...
                                <TableCell>
                                    {p.pmo && (
                                        <div className={cn("flex items-center text-xs", pmoMapper(p.pmo).icon === HourglassIcon ? 'text-gray-300' : 'text-gray-700')}>
                                ...
                                <TableCell>
                                    {p.enedis && (
                                        <div className={cn("flex items-center text-xs", EnedisIcon === HourglassIcon ? 'text-gray-300' : 'text-gray-700')}>
                                ...
                                <TableCell>
                                    {p.sales && (
                                        <div className={cn("flex items-center text-xs", SalesIcon === HourglassIcon ? 'text-gray-300' : 'text-gray-700')}>
                                ...
                                <TableCell>
                                            ...
                                            <Tooltip>
                                                <TooltipTrigger>
                                                    <Button
                                                        ...
                                                        variant={'link'}
                                                    >
                                                        Envoyer<SendIcon className={'size-4 ml-2 animate-bounce hover:animate-none'} />
                                                    </Button>
                                                </TooltipTrigger>
                                                <TooltipContent>
                                    ...
                                    <TooltipProvider>
                                        <Tooltip>
                                            <TooltipTrigger>
                                                <Button onClick={() => reject(p.id)} size={'sm'} className={'text-red-500 text-xs'} variant={'link'}>
                                                    Refuser<XIcon className={'size-4 ml-1'} />
                                                </Button>
                                            </TooltipTrigger>
                                            <TooltipContent>
                                                <p>Refuser {p.name}</p>
