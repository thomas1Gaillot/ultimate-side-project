...
const SalesSubscriptionDialogContent = ({ignored}:{ignored:boolean}) => {

    const [openModal, setOpenModal] = useState(false)
    const {setSalesDemarches} = useStoredPrestations();

    function subscribe() {
        setSalesDemarches('active');
        setOpenModal(false)
    }

    function ignore() {
        setSalesDemarches('disabled');
        setOpenModal(false)
    }
    ...
    return (<Dialog open={openModal}
            ...
            <DialogContent className="bg-white">
                <DialogHeader>
                    <DialogTitle>Souscription à la prestation : Contrats de vente</DialogTitle>
                </DialogHeader>
                <div
                    ...
                    <div className="space-y-6 px-4 py-10   overflow-y-auto lg:space-y-10">
                        ...
                        <div className={"grid grid-cols-[100px_1fr]"}>
                            ...
                            <div>
                                <h2 className="text-lg font-bold text-gray-800 dark:text-white">{"Contrat de vente"}</h2>
                        ...
                        <div className="flex gap-x-5 sm:gap-x-8">
                            ...
                            <div className="grow">
                                <h3 className="font-semibold text-gray-800 dark:text-neutral-200">{"Proposition d'un prix de vente"}</h3>
                                <p className="mt-1  text-xs text-gray-600">
...
export default SalesSubscriptionDialogContent;