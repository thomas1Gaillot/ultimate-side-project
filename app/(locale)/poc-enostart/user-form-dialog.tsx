  ...
  const FormContent = () => (
      <form className="space-y-6">
        ...
        <div>
          ...
          <RadioGroup className="grid grid-cols-2 gap-4 mt-2" onValueChange={(value : any) => setUserType(value as 'professionnel' | 'particulier')}>
            <Label
            ...
            <Card>
              <CardContent className="space-y-4 pt-4">
                ...
                <div>
                  ...
                  <Select onValueChange={(value) => setFormeJuridique(value as 'SA-SAS-SARL' | 'Association' | 'Copropriété')}>
          ...
          <CardContent className="space-y-4 pt-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input id="email" type="email" placeholder="votre@email.com" defaultValue="default@email.com" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
  ...
  return (
      <Dialog>
        <DialogTrigger asChild>
          <Button className={"text-gray-600"} variant={'secondary'} size={'sm'}>
            {"v0 formulaire à update"}
